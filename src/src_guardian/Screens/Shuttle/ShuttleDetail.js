...
import { getGroupForGuardian, getWaypoints, startGuide, stopGuide } from '../../../api/shuttleApi';
            ...
            <WaypointCard
              ...
              onPress={() =>
                navigation.navigate('ShuttleStudentsList', {
                  waypoint: item, 
                  groupInfo: groupInfo, 
                  previousAttendanceComplete: waypoints[item.waypointOrder - 2] ? waypoints[item.waypointOrder - 2].attendanceComplete : true
                })
              }
